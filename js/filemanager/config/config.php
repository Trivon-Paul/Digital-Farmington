...
$base_url="/app";  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/u/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../u/'; // relative path from filemanager folder to upload folder (with final /)
...
// YOU CAN ALSO PASS THIS PARAMETERS USING SESSION VAR => $_SESSION['CHA']["VIEW"]=
//
//******************
$default_view=1;
