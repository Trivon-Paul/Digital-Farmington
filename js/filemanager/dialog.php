...
$_SESSION['CHA']["verify"]= "RESPONSIVEfilemanager";
 ...
 *SUB-DIR CODE
 ***/
if(!isset($_SESSION['CHA']["subfolder"])) $_SESSION['CHA']["subfolder"]='';
$subfolder = '';
if(!empty($_SESSION['CHA']["subfolder"]) && strpos($_SESSION['CHA']["subfolder"],'../')===FALSE
   && strpos($_SESSION['CHA']["subfolder"],'./')===FALSE && strpos($_SESSION['CHA']["subfolder"],"/")!==0
    && strpos($_SESSION['CHA']["subfolder"],'.')===FALSE) $subfolder= $_SESSION['CHA']['subfolder'];
...
//view type
if(!isset($_SESSION['CHA']["view_type"])){ $view=$default_view; $_SESSION['CHA']["view_type"] = $view; }
if(isset($_GET['view'])){ $view=$_GET['view']; $_SESSION['CHA']["view_type"] = $view; }
$view=$_SESSION['CHA']["view_type"];

if(isset($_GET["filter"])) $filter=fix_filename($_GET["filter"],$transliteration);
else $filter='';

if(!isset($_SESSION['CHA']['sort_by'])) $_SESSION['CHA']['sort_by']='';
if(isset($_GET["sort_by"])) $sort_by=$_SESSION['CHA']['sort_by']=fix_filename($_GET["sort_by"],$transliteration);
else $sort_by=$_SESSION['CHA']['sort_by'];

if(!isset($_SESSION['CHA']['descending'])) $_SESSION['CHA']['descending']=false;
if(isset($_GET["descending"])) $descending=$_SESSION['CHA']['descending']=fix_filename($_GET["descending"],$transliteration)==="true";
else $descending=$_SESSION['CHA']['descending'];
...
if(isset($_GET['attr'])) $attr = $_GET['attr']; else $attr="";
...
<html xmlns="https://www.w3.org/1999/xhtml">
    ...
    <body>
	<input type="hidden" id="target_attr" value="<?php echo $attr; ?>" />
