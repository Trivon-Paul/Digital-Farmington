...
if($_SESSION['CHA']["verify"] != "RESPONSIVEfilemanager") die('forbiden');
...
if(isset($_GET['action']))
	...
	case 'view':
	    if(isset($_GET['type']))
		$_SESSION['CHA']["view_type"] =$_GET['type'];
	    else
		die('view type number missing');
	    break;
	case 'sort':
	    if(isset($_GET['sort_by']))
		$_SESSION['CHA']["sort_by"] =$_GET['sort_by'];
	    if(isset($_GET['descending']))
		$_SESSION['CHA']["descending"] =$_GET['descending']==="true";
	    break;
	case 'image_size':
